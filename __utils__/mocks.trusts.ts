...
import { AddHeirDto } from 'src/modules/trusts/dto/add-trusted-user.dto';
...
export const addHeir = jest.fn(async (_add_heir_user_dto: AddHeirDto, user: CreateUserDto): Promise<User> => {
